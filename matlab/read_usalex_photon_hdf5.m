...
alex_period = h5read(filename, '/photon_data/photon_data.measurement_specs.alex_period')
...
fprintf('ALEX period: %d  \nDonor period: %s      Acceptor period: %s', [alex_period; donor_period; acceptor_period])
...
timestamps_mod = mod(timestamps, alex_period)
